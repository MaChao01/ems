<template>
	<div style='text-align: center;'>
		<h1>修改报岗记录</h1>
		<el-row>
		  <el-col :span="12"><el-input style='width:300px;margin-top: 20px;' placeholder='请输入装载量(吨)' v-model='cause'></el-input>
		  <el-select v-model="shipname" style='width:45%' placeholder='请输入船队名称'>
		  		<el-option v-for="(obj,index) in shipnamearr"  :value="obj.typeid">{{obj.devname}}</el-option>
		  </el-select>
		  </el-col>
		  </el-col>
		 </el-row>
